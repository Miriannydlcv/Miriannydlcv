...
🔗 [LinkedIn](https://linkedin.com/in/mirianny-de-la-cruz-ventura-a45356273/)  
...
### SQL
- Construcción de consultas analíticas con agregaciones, joins y CTEs.
- Estructuración de datasets: Modelado de datos relacional (tablas de hechos y dimensiones) orientado a análisis.
- Limpieza y transformación de información a nivel de base de datos.
- Filtrado y segmentación por variables de negocio y análisis comparativo.
...
### Tableau
- Construcción de dashboards (desembolsos, campañas, gestión de descuentos, análisis y nichos de mercado y desempeño comercial).
- Visualizaciones interactivas con filtros y segmentación.
- Uso de parámetros para análisis dinámico.
- Construcción de KPIs y métricas derivadas.
- Creación de mapas y visualizaciones geográficas.
...
<!--
**Miriannydlcv/Miriannydlcv** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
